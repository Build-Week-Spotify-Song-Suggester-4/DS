...
# this line of code searches for the track "Time"
# it also encodes the string so that it can be passed to the URL
# in the correct format when making the request
